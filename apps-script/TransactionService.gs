...
function normalizeTransaction(record) {
  return {
    ...
    operationDateStart: formatDate(record.operationDateStart || record.operationDate),
    operationDateEnd: formatDate(record.operationDateEnd || record.operationDateStart || record.operationDate),
